	...
	*/
	...
	{  
	    ...
	    // above if you want to change what you mean by "moderate" and "light")
     		...
     		if (mag < THRESHOLD_LIGHT ) {
				...
				marker.setColor(color(224, 36, 11));
				marker.setRadius(15);
			}
	...
	private void addKey() {
		...
		text("Earthquake Key",45 , 70);
     	 ...
     	 fill(224, 36, 11);
     	ellipse(39, 115, 15, 16);
		 fill(0, 0, 0);
		text("5.0+ Magnitude",60 , 120);

		fill(255, 255, 0);
		ellipse(39, 155, 10, 11);
		fill(0, 0, 0);
		...
		ellipse(39, 200, 8, 8);
		fill(0, 0, 0);
		text("Below 4.0",60 , 200);
	}
	public static void main (String... args) {
		EarthquakeCityMap pt = new EarthquakeCityMap();
		PApplet.runSketch(new String[]{"Project 1"}, pt);
	}
}
